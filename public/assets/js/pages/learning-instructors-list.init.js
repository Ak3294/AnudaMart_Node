            ...
            series: [
                {
                    name: "New Orders",
                    data: [
                        32, 18, 13, 17, 26, 34, 47, 51, 59, 63, 44, 38, 53, 69,
                        72, 83, 90, 110, 130, 117, 103, 92, 95, 119, 80, 96,
                        116, 125,
                    ],
                },
                {
                    ...
                    data: [
                        ...
                        32, 41, 34, 29, 37, 70, 55, 49, 36, 30, 52, 38, 33,
                    ],
                },
            ],
            ...
            e.addEventListener("click", function (e) {
                ...
                Array.from(e).forEach(function (e) {
                    ...
                    n == itemId &&
                        ((editList = !0),
                        (document.getElementById(
                            "addInstructorModalLabel"
                        ).innerHTML = "Edit Instructor Details"),
                  ...
                  !editList
                      ? (instructorList.add({
                        ...
                        document
                            ...
                            .classList.add("d-none"),
                        document
                            .getElementById("close-addInstructorModal")
                            .click(),
                        count++,
                        clearFields(),
                        refreshCallbacks(),
