    ...
    var t = {
                    ...
                    var r = {
                        ...
                        item: function (t, e, n) {
                            for (var s = !0, i = 0; i < n.length; i++) {
                                for (
                                    var a = !1, o = 0, l = e.length;
                                    o < l;
                                    o++
                                )
                                    r.values(t.values(), e[o], n[i]) &&
                                        (a = !0);
                                a || (s = !1);
                            }
                            t.found = s;
            ...
            "./src/sort.js": function (t) {
                t.exports = function (t) {
                        ...
                        r = function () {
                            ...
                            var r = {},
                                n =
                                    ...
                                    void 0;
                            n
                                ? ((r.valueName = t.utils.getAttribute(
                                      n,
                                      "data-sort"
                                  )),
                                  e.getInSensitive(n, r),
                                  (r.order = e.getOrder(n)))
                                : (((r = arguments[1] || r).valueName =
                                      arguments[0]),
                                  (r.order = r.order || "asc"),
                                  (r.insensitive =
                                      void 0 === r.insensitive ||
                                      r.insensitive)),
                                e.clear(),
                                e.setOrder(r);
                            var s,
                    ...
                    return (
                        ...
                        (t.handlers.sortComplete =
                            t.handlers.sortComplete || []),
                        (e.els = t.utils.getByClass(
                            t.listContainer,
                            t.sortClass
                        )),
                        ...
                        i = function (t) {
                            if ("string" == typeof t) {
                                if (/<tr[\s>]/g.exec(t)) {
                                    ...
                                    return (
                                        (e.innerHTML = t), e.firstElementChild
                                    );
                                }
                                if (-1 !== t.indexOf("<")) {
                                    var r = document.createElement("div");
                                    return (
                                        (r.innerHTML = t), r.firstElementChild
                                    );
                                }
                            }
                        },
            ...
            "./src/utils/get-attribute.js": function (t) {
                t.exports = function (t, e) {
                    ...
                    if (!r)
                        for (
                            var n = t.attributes, s = n.length, i = 0;
                            i < s;
                            i++
                        )
                            void 0 !== n[i] &&
