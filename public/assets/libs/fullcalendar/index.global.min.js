...
var FullCalendar = (function (e) {
    ...
    function Go(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Zo(
                    e,
                    t.sourceIds ? wt(t.sourceIds) : $o(e, r),
                    i,
                    t.isRefetch || !1,
                    r
                );
    ...
    class ua {
        constructor(e) {
            (this.computeCurrentViewData = nn(this._computeCurrentViewData)),
                ...
                (this.buildDateEnv = nn(ha)),
                (this.buildTheme = nn(fa)),
                (this.parseToolbars = nn(ra)),
                (this.buildViewSpecs = nn(Lo)),
                (this.buildDateProfileGenerator = rn(ga)),
                (this.buildViewApi = nn(pa)),
                (this.buildViewUiProps = rn(ya)),
                (this.buildEventUiBySource = nn(ma, Rt)),
                (this.buildEventUiBases = nn(va)),
                (this.parseContextBusinessHours = rn(Ea)),
                (this.buildTitle = nn(da)),
                (this.emitter = new Hr()),
    ...
    class xa extends Zr {
        constructor() {
            super(...arguments),
                ...
                (this.buildViewPropTransformers = nn(Ta)),
                (this.buildToolbarProps = nn(_a)),
    ...
    class Na {
        ...
        destroy() {
            this.containerEl.removeEventListener(
                ...
                (Ia -= 1),
                Ia ||
                    window.removeEventListener("touchmove", Pa, {
                        passive: !1,
                    });
        }
        tryStart(e) {
    ...
    class Fa {
        constructor(e) {
            (this.origRect = Or(e)),
                (this.scrollCaches = Nr(e).map((e) => new ja(e, !0)));
        }
        destroy() {
            for (let e of this.scrollCaches) e.destroy();
        }
                    ...
                    (this.context = e),
                        ...
                        (this.onDocumentPointerDown = (e) => {
                            ...
                            (this.matchesCancel = !!Ie(n, t)),
                                (this.matchesEvent = !!Ie(n, Ya.SELECTOR));
                        }),
    ...
    ml.addStateEquality({ eventInstanceHeights: Rt });
    class vl extends Jr {
        constructor() {
            super(...arguments),
                (this.splitBusinessHourSegs = nn(el)),
                (this.splitBgEventSegs = nn(el)),
                (this.splitFgEventSegs = nn(el)),
                (this.splitDateSelectionSegs = nn(el)),
                (this.splitEventDrag = nn(nl)),
                (this.splitEventResize = nn(nl)),
                (this.rowRefs = new js());
        }
        render() {
            let { props: e, context: t } = this,
    ...
    const Yl = yn({ hour: "numeric", minute: "2-digit", meridiem: !1 });
    class Zl extends Xr {
        render() {
            return p(
                eo,
    ...
    class Kl extends Xr {
        constructor() {
            super(...arguments),
                (this.splitFgEventSegs = nn(jl)),
                (this.splitBgEventSegs = nn(jl)),
                (this.splitBusinessHourSegs = nn(jl)),
                (this.splitNowIndicatorSegs = nn(jl)),
                (this.splitDateSelectionSegs = nn(jl)),
                (this.splitEventDrag = nn(zl)),
                (this.splitEventResize = nn(zl)),
                (this.rootElRef = { current: null }),
                (this.cellElRefs = new js());
        }
        render() {
        ...
        views: {
            timeGrid: {
                component: class extends Ol {
                    constructor() {
                        super(...arguments),
                            (this.buildTimeColsModel = nn(ac)),
                            (this.buildSlatMetas = nn(oc));
                    }
                    render() {
                        let {
                                options: e,
    ...
    const uc = yn({ hour: "numeric", minute: "2-digit", meridiem: "short" });
    class hc extends Xr {
        render() {
            let { props: e, context: t } = this,
                { options: n } = t,
    ...
    const Sc = yn({ year: "numeric", month: "long" }),
        Ac = yn({ month: "long" });
    function Dc(e, t) {
        return (
            e ||
        ...
        views: {
            multiMonth: {
                component: class extends Jr {
                    constructor() {
                        super(...arguments),
                            (this.splitDateProfileByMonth = nn(Ec)),
                            (this.buildMonthFormat = nn(Dc)),
