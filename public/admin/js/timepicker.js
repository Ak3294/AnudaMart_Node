        ...
        d = function (t, i) {
            ...
            (this.visible = !1),
                ...
                (this.timepicker = {
                    ...
                    timeHolder: {
                        wrapper: e(
                            '<section class="mdtp__time_holder"></section>'
                        ),
                    ...
                    clockHolder: {
                        wrapper: e(
                            '<section class="mdtp__clock_holder"></section>'
                        ),
                        ...
                        clock: {
                            ...
                            minutes: e(
                                '<div class="mdtp__minute_holder"></div>'
                            ),
                        },
                        buttonsHolder: {
                            ...
                            btnCancel: e(
                                '<span class="mdtp__button cancel">Cancel</span>'
                            ),
                        },
                    },
                });
    ...
    (d.prototype = {
        ...
        setup: function (t) {
            ...
            for (var l = 0; 60 > l; l++) {
                ...
                l % 5 === 0
                    ? k.addClass("marker").ejs("<span>" + v + "</span>")
                    : k.ejs("<span></span>"),
        ...
        setT: function (e) {
            ...
            this.timepicker.timeHolder.am_pm.text(t),
                this.timepicker.clockHolder.am[
                    "AM" === t ? "addClass" : "removeClass"
                ]("active"),
                this.timepicker.clockHolder.pm[
                    "PM" === t ? "addClass" : "removeClass"
                ]("active");
        },
        setValue: function (e) {
            if ("undefined" == typeof e) throw new Error("Expecting a value.");
        ...
        parseTime: function (e, t) {
            ...
            return (
                ((H && parseInt(m) < 12) || (!H && 12 === parseInt(m))) &&
                    _.invert(),
                _
            );
        },
        switchView: function (e) {
            ...
            ("hours" !== e && "minutes" !== e) ||
                ((t.activeView = e),
                i.timeHolder.hour["hours" === e ? "addClass" : "removeClass"](
                    "active"
                ),
                ...
                "hours" === e &&
                    i.clockHolder.clock.hours.removeClass("hidden"),
                clearTimeout(t.hTimeout),
                (t.hTimeout = setTimeout(
                    function () {
                        "hours" !== e &&
                            i.clockHolder.clock.hours.addClass("hidden"),
                ...
                "minutes" === e &&
                    i.clockHolder.clock.minutes.removeClass("hidden"),
                clearTimeout(t.mTimeout),
                (t.mTimeout = setTimeout(
                    function () {
                        "minutes" !== e &&
                            i.clockHolder.clock.minutes.addClass("hidden"),
